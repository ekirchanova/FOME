...
"background-color: rgb(177, 198, 222);")
        ...
        #self.pushButton_2.setGeometry(QtCore.QRect(250, 470, 121, 61))
       # self.pushButton_2.setObjectName("pushButton_2")

        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setGeometry(QtCore.QRect(280, 490, 81, 31))
    ...
    def retranslateUi(self, MainWindow):
       ...
       # self.pushButton_2.setText(_translate("MainWindow", "LOG"))
        self.checkBox.setText(_translate("MainWindow", "LogAxis"))