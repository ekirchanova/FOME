...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab8 = pg.PlotWidget()
        self.tab8.setObjectName("tab")
        self.tabWidget.addTab(self.tab8, "")
        self.tab8.setBackground("f0f0f0")
        self.tab9 = pg.PlotWidget()
        self.tab9.setObjectName("tab")
        self.tabWidget.addTab(self.tab9, "")
        self.tab9.setBackground("f0f0f0")
    ...
    def retranslateUi(self, MainWindow):
       ...
       # self.tabWidget.setStyleSheet(background-color: white')
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab9), _translate("MainWindow", "Electron Mobility"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab8), _translate("MainWindow", "Hole Mobility"))
